...
function preload() {
  dotImg = loadImage('templates/angry_birds/images/dot.png');
  boxImg = loadImage('templates/angry_birds/images/equals.png');
  bkgImg = loadImage('templates/angry_birds/images/skyBackground.png');
}
